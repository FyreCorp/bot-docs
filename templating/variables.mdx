...
- `track.listeners`: The amount of track listeners on Last.fm.
- `track.nowPlaying`: If you are currently listening to the track (boolean).
- `track.userPlayCount`: The Last.fm user play count for the track.
...
## Ticket Channel Name Variables
These variables are supported in the channel name formats of ticket categories.
