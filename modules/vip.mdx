...
icon: 'gem'
title: 'VIP'
description: "Learn how Fyre's VIP module works, and how to configure it."
---
...
- `name` - The name of the new VIP tier (max 32 chars).
- `vip-role` - The primary role of the new VIP tier.
