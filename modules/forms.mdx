...
![Form User Confirmation Prompt Example](/screenshots/forms/user-confirmation-prompt.png)
...
![Form Admin Confirmation Prompt Template Example](/screenshots/forms/admin-confirmation-prompt-template.png)
...
After using this command, a modal will popup allowing you to enter a template for the form panel.
Form panels don't support any template variables.

![Form Admin Create Panel Template Example](/screenshots/forms/admin-create-panel-template.png)
...
![Form Admin Create Panel Selector Example](/screenshots/forms/admin-create-panel-selector.png)
