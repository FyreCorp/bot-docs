...
To configure auto-threading in a channel, use `/channels auto-thread` and fill in the desired options.

### Config Options
There are a few options available for auto-threading, here's a list and what they do.
