...
(supports [variables](/misc/variables#ticket-channel-name-variables). default: ticket-\{username\}).

- `claimed-name-format`: The channel name format for when a ticket is claimed
(supports [variables](/misc/variables#ticket-channel-name-variables). default: none).
